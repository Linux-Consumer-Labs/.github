...
**Researching ways to reach "Just Works" on the Linux desktop.**

linux consumer labs is an open research organization. We study the gap between what Linux *can* do and what everyday users *experience* — and explore paths to close it without abandoning what makes Linux valuable.
...
All linux consumer labs repositories are licensed under the [MIT License](LICENSE).
